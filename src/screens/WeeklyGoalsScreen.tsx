...
// import { View, StyleSheet, ScrollView, TextInput, Alert, Text, Platform, KeyboardAvoidingView, TouchableOpacity } from 'react-native';
// import { SafeAreaView } from 'react-native-safe-area-context';
// import LottieView from 'lottie-react-native';
// import { ScreenTitle, CardHeader } from '../components/common/StyledText';
// import { colors } from '../theme/color';
...
// const PROGRESS_STEPS = [0, 25, 50, 75, 100]; // Progress segments

// // Segmented Progress Tracker
// const SegmentedProgressTracker = ({ progress, onProgressChange, color }: any) => {
//   return (
//     <View style={styles.trackerContainer}>
//       {PROGRESS_STEPS.map((step, index) => {
//         const isActive = progress >= step;
...
// // Weekly Goal Card (UI same as before)
// const WeeklyGoalCard = ({ title, placeholder, value, onChangeText, progress, onProgressChange, gradient }: any) => {
//   const isCompleted = progress === 100;
...
//       if (!goal.text || goal.text.trim() === '') continue; // skip empty goals
...
//       const data = await res.json();
//       if (!res.ok) throw new Error(data.error || 'Failed to save goal'); // check 'error' field
//     }
...
//             onChangeText={(text: string) => setGoal1(g => ({ ...g, text }))}
//             progress={goal1.progress}
//             onProgressChange={(progress: number) => setGoal1(g => ({ ...g, progress }))}
//             gradient={colors.gradient.cool}
//           />
//           <WeeklyGoalCard 
//             title="Objective 2"
...
//             onChangeText={(text: string) => setGoal2(g => ({ ...g, text }))}
//             progress={goal2.progress}
//             onProgressChange={(progress: number) => setGoal2(g => ({ ...g, progress }))}
//             gradient={colors.gradient.warm}
//           />
//           <WeeklyGoalCard 
//             title="Objective 3"
...
//             onChangeText={(text: string) => setGoal3(g => ({ ...g, text }))}
//             progress={goal3.progress}
//             onProgressChange={(progress: number) => setGoal3(g => ({ ...g, progress }))}
//             gradient={colors.gradient.passion}
//           />
//         </ScrollView>
