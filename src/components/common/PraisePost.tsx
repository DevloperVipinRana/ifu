...
// const SCREEN_WIDTH = Dimensions.get('window').width;
// const MAX_IMAGE_HEIGHT = 500; // Maximum height to prevent extremely tall images
...
//   // Calculate image height based on aspect ratio
//   const getImageHeight = () => {
//     if (!imageAspectRatio) return 250; // Default height while loading
...
//           {comments.map((c, idx) => (
//             <Text key={idx} style={{ marginBottom: 5, color: colors.text.primary }}>
...
//               <Text style={{ color: colors.gradient.passion[0], fontWeight: 'bold' }}>Send</Text>
//             </TouchableOpacity>
//           </View>
//         </View>
//       )}
...
//   avatar: { width: 40, height: 40, borderRadius: 20, marginRight: 10, backgroundColor: colors.border },
//   postText: { fontSize: 16, lineHeight: 24, paddingHorizontal: 20 },
//   postImage: { 
//     width: '100%',
//     marginTop: 10,
//   },
//   footer: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around', borderTopWidth: 1, borderColor: colors.border },
//   actionButton: { flexDirection: 'row', alignItems: 'center', paddingVertical: 15 },
//   actionText: { marginLeft: 8, fontFamily: 'Inter-SemiBold', color: colors.text.secondary },
// });