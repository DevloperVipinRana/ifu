...
const styles = StyleSheet.create({
  ...
  listContent: {
    paddingVertical: 16, // Changed from padding: 16
  },
  emptyListContent: {
    flexGrow: 1,
    justifyContent: 'center',
    paddingHorizontal: 32, // Add horizontal padding for empty state
  },
  postContainer: {
    marginBottom: 8,
  },
  deleteButton: {
    ...
    paddingHorizontal: 16,
    marginTop: 2,
    marginHorizontal: 16, // Keep horizontal margin for delete button
    marginBottom: 16,
    shadowColor: '#000',
